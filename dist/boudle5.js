...
window.onload = function () {
	...
	// 	graphql(schema1,'{shared}',root2).then((response) => {
...
var query =`
{
 ...
 `;
 // console.log(root1);
	__WEBPACK_IMPORTED_MODULE_0_graphql__["graphql"](__WEBPACK_IMPORTED_MODULE_1__graphql_js__["b" /* schema1 */],query,__WEBPACK_IMPORTED_MODULE_1__graphql_js__["a" /* root1 */]).then((response) => {
 console.log(response.data.getObj.share);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return schema1; });
